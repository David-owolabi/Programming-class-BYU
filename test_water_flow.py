from water_flow import water_column_height, pressure_loss_from_pipe, pressure_loss_from_fittings, reynolds_number, pressure_loss_from_pipe_reduction,pressure_gain_from_water_height, kpa_to_psi
...
def test_kpa_to_psi():
    ...
    assert kpa_to_psi(250.0) == approx(36.2595, abs=0.001)
